...
<form method="post" class="form-inline woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="btn btn-success woocommerce-Button button" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
	</p>
